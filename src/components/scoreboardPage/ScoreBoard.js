					...
					{sortedScoreBoard.map((row, index) => {
						...
						return (
							<TableRow key={index}>
								<TableCell component='th' scope='row'>
									<Box display='flex' alignItems='center' pl={theme.spacing(4)}>
										<Avatar alt='avatar' src={avatars[player.avatarIndex]} sx={{ width: 45, height: 45, mr: theme.spacing(1) }} />
								...
								<TableCell align='right'>
									<Typography variant='subtitle1' color='secondary' fontWeight={'bold'} pr={theme.spacing(4)}>
										{row.points}
									</Typography>
								</TableCell>
							</TableRow>
